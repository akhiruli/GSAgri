...
public class EnergyModelComputingNode {
	...
	public void updateDynamicEnergyConsumption(double length, double mipsCapacity){
		cpuEnergyConsumption += 20*((getMaxActiveConsumption() - getIdleConsumption()) / 3600 * length / mipsCapacity);
	 }
	public void updateDynamicEnergyConsumption(double mipsCapacity, double mipsRequirement, double latency) {
		...
		* */
		//double x = (0.01 * (mipsRequirement*mipsRequirement)/(mipsCapacity*mipsCapacity)*latency)/3600;
		//cpuEnergyConsumption += (0.5 * (mipsRequirement*mipsRequirement)/(mipsCapacity*mipsCapacity)*latency)/3600; //alpha = 0.5
		cpuEnergyConsumption += ((mipsRequirement*mipsRequirement)/(mipsCapacity*mipsCapacity)*latency)/3600; //alpha = 0.5
	}
